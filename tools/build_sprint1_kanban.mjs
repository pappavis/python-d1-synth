...
const futureStories = [
  ...
  ["US-021", "Story", "Future MIDI En DAW Integratie", "External MIDI Workflow In Logic", "In Review", "Should", "Release Engineer", 3, "Future", "External MIDI workflow in Logic is reproduceerbaar beschreven en wacht op klanttest.", "Logic external MIDI setup test faalt of ontbreekt.", "Logic/IAC workflowdoc en handmatige testtemplate.", "US-020", "docs/logic_external_midi_workflow_v0.1.0.md; wacht op Logic Pro 12.3 testresultaat."],
