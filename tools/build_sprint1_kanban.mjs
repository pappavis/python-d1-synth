...
const futureStories = [
  ...
  ["US-022", "Story", "Future MIDI En DAW Integratie", "USB MIDI Hardware Input", "In Review", "Must", "Lead Developer", 5, "Future", "Generieke USB MIDI inputdiagnose werkt na list-devices en expliciete device/default keuze.", "USB MIDI readiness, CLI guidance, docs en traceability tests falen.", "UsbMidiHardwareInputAdapter, midi diagnose-usb-input en scan-failure guidance.", "US-019, US-024", "KodeklopperM4 test: Logic toont devices, Python backend scan faalt; wacht op gekozen/default device of MuziekM4 test."],
