...
const futureStories = [
  ...
  ["US-029", "Story", "Future MIDI En DAW Integratie", "Logic/DAW Virtual MIDI Naar Audio Trigger", "In Review", "Must", "DSP Engineer", 8, "Future", "Logic/DAW stuurt MIDI naar virtual port en python-d1-synth speelt hoorbare audio.", "Virtual MIDI audio trigger en CLI play-virtual tests falen totdat fake virtual MIDI naar fake audio werkt.", "MidoVirtualMidiInputBackend, VirtualMidiAudioTriggerSettings/Result, VirtualMidiAudioTrigger en midi play-virtual command.", "US-027, US-028", "pytest groen; handmatige Logic Pro test pauzeert bij klant."],
];
