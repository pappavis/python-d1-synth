...
const futureStories = [
  ...
  ["US-032", "Story", "Future MIDI En DAW Integratie", "Duplicate MIDI Event Guard", "In Review", "Must", "DSP Engineer", 5, "Future", "Dubbele MIDI note events uit Logic/routing spelen niet dubbel hoorbaar af, zonder simultane verschillende noten te onderdrukken.", "Dedup window, streaming duplicate suppression, CLI diagnostics en traceability tests falen.", "DuplicateMidiEventGuard, --dedupe-window, suppressed_duplicate_count en docs/duplicate_midi_event_guard_v0.1.0.md.", "US-031", "In review: Logic/CoreMIDI echo-paren worden gefilterd; polyfonie, pitch bend en modulation blijven latere stories."],
