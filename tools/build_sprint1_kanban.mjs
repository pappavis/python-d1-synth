...
const futureStories = [
  ...
  ["US-022", "Story", "Future MIDI En DAW Integratie", "USB MIDI Hardware Input", "In Review", "Must", "Lead Developer", 5, "Future", "Generieke USB MIDI inputdiagnose werkt voor KeyLab, Fishman TriplePlay, M-Vave en andere inputdevices.", "USB MIDI readiness, CLI diagnose, docs en traceability tests falen.", "UsbMidiHardwareInputAdapter en midi diagnose-usb-input.", "US-019, US-024", "Wacht op handmatige hardwaretest met minimaal een echt USB MIDI input device."],
