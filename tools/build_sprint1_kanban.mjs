...
const futureStories = [
  ...
  ["US-042", "Story", "Future MIDI En DAW Integratie", "MIDI Performance Patch YAML Config", "Done", "Should", "Lead Developer", 5, "Future", "midi play-stream kan performance parameters uit YAML laden met CLI override.", "Config loader, CLI precedence, docs tests en Kanban tests falen.", "MidiPerformanceConfig, play-stream --config, examples/midi_performance_patch.yaml en docs.", "US-041", "PO test geslaagd op 2026-07-14: Logic stuurt MIDI naar python-d1-synth en er is hoorbaar geluid via Scarlett 8i6 USB."],
];
...
board.getRange("A2").values = [["ChatOD: CHATOD-20260709-D1PY-MVP-001 | MVP accepted: 2026-07-14 | Stories: US-001 through US-042"]];
...
future.getRange("A2").values = [["MVP accepted on 2026-07-14: Logic Pro External MIDI to python-d1-synth with YAML-driven performance config. Future options: synth character, usability, delivery, plugin feasibility, hardware feasibility."]];
