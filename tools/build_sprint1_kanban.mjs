...
const futureStories = [
  ...
  ["US-022", "Story", "Future MIDI En DAW Integratie", "USB MIDI Hardware Input", "Blocked", "Must", "Lead Developer", 5, "Future", "Generieke USB MIDI inputdiagnose werkt na list-devices en expliciete device/default keuze.", "Hardware MIDI test faalt wanneer Python geen devices scant terwijl Logic devices toont.", "Backenddetails, BLOCKER output en tests/test_hardware_midi.py voor echte device scan.", "US-019, US-024", "Impediment: rtmidi package-conflict opgelost; resterend is CoreMIDI/RtMidi SIGABRT in MidiInCore::initialize (-10833), bevestigd door crashlogs."],
