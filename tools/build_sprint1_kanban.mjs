...
const futureStories = [
  ...
  ["US-028", "Story", "Future MIDI En DAW Integratie", "External MIDI Audio Trigger Integratie", "In Review", "Must", "DSP Engineer", 8, "Future", "Ontvangen MIDI note events triggeren hoorbaar audio via de bestaande synth engine.", "MidiAudioTrigger en midi play-live tests falen totdat fake MIDI naar fake audio werkt.", "MidiAudioTriggerSettings/Result, MidiAudioTrigger en midi play-live command met fake MIDI en fake audio tests.", "US-026, US-027", "pytest groen; story blijft In Review tot klant hoorbare hardwaretest op Mac/Scarlett bevestigt."],
];
