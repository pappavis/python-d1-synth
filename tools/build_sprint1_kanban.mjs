...
const futureStories = [
  ...
  ["US-027", "Story", "Future MIDI En DAW Integratie", "Virtual MIDI Port Voor Logic/DAW", "In Review", "Should", "Lead Developer", 5, "Future", "python-d1-synth kan bounded als virtual MIDI destination zichtbaar worden voor Logic/DAW.", "Logic Pro 12.3 handmatige zichtbaarheidstest moet nog door klant bevestigd worden.", "VirtualMidiPortManager, MidoVirtualMidiPortBackend en midi virtual-port command met fake-backend tests.", "US-026", "pytest groen; story blijft In Review tot Logic Pro de destination python-d1-synth toont of een blocker is vastgelegd."],
