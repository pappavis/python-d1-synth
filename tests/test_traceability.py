...
class TestCodeTraceability:
    ...
    def test_us038_code_contains_required_traceability_fields(self) -> None:
        required = (
            "CHATOD-20260709-D1PY-MVP-001",
            "Sprint 1 Kanban Backlog",
            "EPIC-007 Future MIDI En DAW Integratie",
    ...
    def test_us039_code_contains_required_traceability_fields(self) -> None:
        required = (
            "CHATOD-20260709-D1PY-MVP-001",
            "Sprint 1 Kanban Backlog",
            "EPIC-007 Future MIDI En DAW Integratie",
    ...
    def test_us041_code_contains_required_traceability_fields(self) -> None:
        required = (
            "CHATOD-20260709-D1PY-MVP-001",
            "Sprint 1 Kanban Backlog",
            "EPIC-007 Future MIDI En DAW Integratie",
